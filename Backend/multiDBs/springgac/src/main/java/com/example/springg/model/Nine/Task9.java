package com.example.springg.model.Nine;
...
public class Task9 {
    ...
    public Task9(Long id, String jid, Date dueDate, String articleId, Date receivedDate, String journalComplexity, String department, Long taskId, String taskName, String user) {
        this.id = id;
        this.jid = jid;
