package com.example.springg.model.Ten;
...
public class Task10 {
    ...
    public Task10(Long id, String jid, Date dueDate, String articleId, Date receivedDate, String journalComplexity, String department, Long taskId, String taskName, String user) {
        this.id = id;
        this.jid = jid;
