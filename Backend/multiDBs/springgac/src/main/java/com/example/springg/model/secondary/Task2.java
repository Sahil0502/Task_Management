package com.example.springg.model.secondary;
...
public class Task2 {
        ...
        public Task2(Long id, String jid, Date dueDate, String articleId, Date receivedDate, String journalComplexity, String department, Long taskId, String taskName, String user) {
            this.id = id;
            this.jid = jid;
