package com.example.springg.model.Fourth;
...
public class Task4 {
    ...
    public Task4(Long id, String jid, Date dueDate, String articleId, Date receivedDate, String journalComplexity, String department, Long taskId, String taskName, String user) {
        this.id = id;
        this.jid = jid;
