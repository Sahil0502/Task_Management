package com.example.springg.model.Fifth;
...
public class Task5 {
    ...
    public Task5(Long id, String jid, Date dueDate, String articleId, Date receivedDate, String journalComplexity, String department, Long taskId, String taskName, String user) {
        this.id = id;
        this.jid = jid;
