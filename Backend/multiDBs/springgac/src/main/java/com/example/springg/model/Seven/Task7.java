package com.example.springg.model.Seven;
...
public class Task7 {
    ...
    public Task7(Long id, String jid, Date dueDate, String articleId, Date receivedDate, String journalComplexity, String department, Long taskId, String taskName, String user) {
        this.id = id;
        this.jid = jid;
